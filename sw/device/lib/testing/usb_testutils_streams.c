...
static status_t strm_tx_done(void *cb_v, usb_testutils_xfr_result_t result) {
  ...
  usbdev_stream_cb_t *cb = (usbdev_stream_cb_t *)cb_v;
  ...
  if (nqueued > 0) {
    // Advance the 'commited transmission' state for this stream
