...
typedef struct usb_testutils_buffer {
  /**
   ...
   * prepared for sending; if next_valid is false, then
   */
  bool last;
  /**
...
struct usb_testutils_ctx {
  ...
  struct {
    ...
    void (*reset)(void *);
    /**
     * Current in-progress buffer, if any
     */
...
/**
 * Send a larger buffer of data from the given endpoint
 *
