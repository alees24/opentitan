...
package top_darjeeling_racl_pkg;
  ...
  parameter top_racl_pkg::racl_policy_sel_t RACL_POLICY_SEL_MBX0_SOC_WIN_WDATA = 0;
  parameter top_racl_pkg::racl_policy_sel_t RACL_POLICY_SEL_MBX0_SOC_WIN_RDATA = 0;
  ...
  parameter top_racl_pkg::racl_policy_sel_t RACL_POLICY_SEL_MBX1_SOC_WIN_WDATA = 0;
  parameter top_racl_pkg::racl_policy_sel_t RACL_POLICY_SEL_MBX1_SOC_WIN_RDATA = 0;
  ...
  parameter top_racl_pkg::racl_policy_sel_t RACL_POLICY_SEL_MBX2_SOC_WIN_WDATA = 0;
  parameter top_racl_pkg::racl_policy_sel_t RACL_POLICY_SEL_MBX2_SOC_WIN_RDATA = 0;
  ...
  parameter top_racl_pkg::racl_policy_sel_t RACL_POLICY_SEL_MBX4_SOC_WIN_WDATA = 0;
  parameter top_racl_pkg::racl_policy_sel_t RACL_POLICY_SEL_MBX4_SOC_WIN_RDATA = 0;
  ...
  parameter top_racl_pkg::racl_policy_sel_t RACL_POLICY_SEL_MBX5_SOC_WIN_WDATA = 0;
  parameter top_racl_pkg::racl_policy_sel_t RACL_POLICY_SEL_MBX5_SOC_WIN_RDATA = 0;
   ...
   *     RDATA: ALL_RD_WR (Idx 0)
   */
  parameter top_racl_pkg::racl_policy_sel_t RACL_POLICY_SEL_MBX_JTAG_SOC [4] = '{
    0, 0, 0, 0
  };
  parameter top_racl_pkg::racl_policy_sel_t RACL_POLICY_SEL_MBX_JTAG_SOC_WIN_WDATA = 0;
  parameter top_racl_pkg::racl_policy_sel_t RACL_POLICY_SEL_MBX_JTAG_SOC_WIN_RDATA = 0;
  ...
  parameter top_racl_pkg::racl_policy_sel_t RACL_POLICY_SEL_MBX_PCIE0_SOC_WIN_WDATA = 2;
  parameter top_racl_pkg::racl_policy_sel_t RACL_POLICY_SEL_MBX_PCIE0_SOC_WIN_RDATA = 2;
  ...
  parameter top_racl_pkg::racl_policy_sel_t RACL_POLICY_SEL_MBX_PCIE1_SOC_WIN_WDATA = 2;
  parameter top_racl_pkg::racl_policy_sel_t RACL_POLICY_SEL_MBX_PCIE1_SOC_WIN_RDATA = 2;
   ...
   */
  parameter top_racl_pkg::racl_policy_sel_t RACL_POLICY_SEL_AC_RANGE_CHECK [167] = '{
