...
export I3C_RTL="$RTL/i3c_consts_pkg.sv $RTL/i3c_pkg.sv $RTL/i3c_reg_pkg.sv $RTL/i3c.sv"
verilator --cc --exe --build --threads 4 --trace-fst -j 4 -I$RTL -I$PRIMGEN -I$PRIM -I$TLUL -I$RACL -I$UVM main.cpp $TOP/top_pkg.sv $PRIM/prim_secded_pkg.sv $PRIM/prim_subreg_pkg.sv $PRIM/prim_mubi_pkg.sv $TLUL/tlul_pkg.sv $PRIM/prim_alert_pkg.sv $PRIM/prim_count_pkg.sv $PRIMGEN/prim_ram_1p_pkg.sv $PRIM/prim_util_pkg.sv $TOP/autogen/top_racl_pkg.sv tb.sv $PRIMGEN/prim_ram_1p.sv $PRIMGEN/prim_buf.sv $PRIMGEN/prim_clock_buf.sv $PRIMGEN/prim_clock_inv.sv $PRIMGEN/prim_flop.sv $PRIMGEN/prim_flop_2sync.sv $I3C_RTL lint.vlt
