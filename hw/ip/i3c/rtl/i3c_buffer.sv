...
#(
  ...
  // Always five clients at present.
  ...
  logic ctrl_txbuf_gnt, targ_txbuf_gnt;
  logic ctrl_rxbuf_gnt, targ_rxbuf_gnt;
  ...
  assign arb_data_in[4] = {swbuf_we_i,      swbuf_cfg_i,      swbuf_wmask_i,      swbuf_wdata_i};
  ...
  assign {swbuf_rdata_o, targ_txbuf_rdata_o, ctrl_txbuf_rdata_o} = {3{mem_rdata}};
