...
#(
  ...
  localparam int unsigned BufAddrWidth = $clog2(BufWords);
  ...
  logic                    swbuf_gnt;
  logic                    swbuf_we;
  logic [BufAddrWidth-1:0] swbuf_addr;
  ...
  i3c_core #(
    ...
    .scl_i          (cio_scl_i),
    .scl_o          (cio_scl_o),
    .scl_en_o       (cio_scl_en_o),
    .sda_i          (cio_sda_i),
    .sda_o          (cio_sda_o),
    .sda_en_o       (cio_sda_en_o),
    .sda_od_en_o    (cio_sda_od_en_o),
  ...
  `ASSERT_KNOWN(SCLEnKnown_A, cio_scl_en_o, clk_i, !rst_ni)
  `ASSERT_KNOWN(SCLKnown_A, cio_scl_o, clk_i, !rst_ni || !cio_scl_en_o)
