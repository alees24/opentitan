...
class usbdev_max_usb_traffic_vseq extends usbdev_base_vseq;
 `uvm_object_utils(usbdev_max_usb_traffic_vseq)
  ...
  // TODO: Support Isochronous endpoints at some point; presently there is no way to differentiate
  // packets and all packets are expected to be delivered reliably.
